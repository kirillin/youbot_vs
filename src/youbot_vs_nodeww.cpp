...
//            ipd.push_back(vpImagePoint(w-100, h+100)); // left bottom
            ...
            // INIT DESIRED FEATURE POINTS
            vpFeaturePoint p[4], pd[4];
//            double Z = 0.5;
//            for (int i = 0; i < 4; i++) {
//                double xd = ipd[i].get_u();
//                double yd = ipd[i].get_v();
//                pd[i].buildFrom(xd, yd, Z);
//            }
                        ...
                        if (!learn) {
                            ...
                            try {
                                ...
                                for(int i = 0; i < Np; i++) {
                                    ...
                                    //if (init_cv) vpFeatureBuilder::create(pd[i], cam, ipd[i]);

//                                    double u = ip[i].get_u();
//                                    double v = ip[i].get_v();
//                                    p[i].buildFrom(u, v, 0.5);  //!!! Z=0.5 is not using here!
//
//                                    if (init_cv) {
